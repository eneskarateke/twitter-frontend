  ...
  return (
    <div className="group-32">
      <div className="group-13">
        ...
        <div className="search-twitter">Search Twitter </div>
        <svg
          className="search"
          width="24"
          height="24"
      ...
      <div className="group-25">
        ...
        <div className="group-26">
          ...
          <div className="trending-in-germany">Trending in Germany </div>
          <div className="_50-4-k-tweets">50.4K Tweets </div>
          <div className="revolution">Revolution </div>
        </div>
